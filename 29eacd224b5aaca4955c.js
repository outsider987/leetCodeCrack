...
const Performance = () => {
    const isShow = (0,react_router_dom__WEBPACK_IMPORTED_MODULE_1__.useLocation)().pathname === '/performance';
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, isShow ? react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "test") : react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Outlet, null));
};
...
//# sourceMappingURL=js/29eacd224b5aaca4955c.js.map