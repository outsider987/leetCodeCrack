"use strict";
(self["webpackChunkleetcodecrack"] = self["webpackChunkleetcodecrack"] || []).push([["vendors-node_modules_react-three_fiber_dist_index-27a1523b_esm_js"],{
...
/* harmony export */   "a": () => (/* binding */ createRoot),
...
/* harmony import */ var scheduler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! scheduler */ "./node_modules/@react-three/fiber/node_modules/scheduler/index.js");
/* harmony import */ var suspend_react__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! suspend-react */ "./node_modules/suspend-react/dist/index.js");
  ...
  for (let i = 0; i < changes.length; i++) {
    ...
    if (isEvent) {
      ...
      // https://github.com/pmndrs/react-three-fiber/issues/274
        ...
        const isColor = targetProp instanceof three__WEBPACK_IMPORTED_MODULE_4__.Color; // Allow setting array scalars

        if (!isColor && targetProp.setScalar) targetProp.setScalar(value); // Layers have no copy function, we must therefore copy the mask property
        else if (targetProp instanceof three__WEBPACK_IMPORTED_MODULE_4__.Layers && value instanceof three__WEBPACK_IMPORTED_MODULE_4__.Layers) targetProp.mask = value.mask; // Otherwise just set ...
        else targetProp.set(value); // For versions of three which don't support THREE.ColorManagement,
        // Auto-convert sRGB colors
        // https://github.com/pmndrs/react-three-fiber/issues/344

        const supportsColorManagement = ( true);
      ...
      if (!rootState.linear && currentInstance[key] instanceof three__WEBPACK_IMPORTED_MODULE_4__.Texture) {
        currentInstance[key].encoding = three__WEBPACK_IMPORTED_MODULE_4__.sRGBEncoding;
      }
    }
...
const createStore = (invalidate, advance) => {
  const rootState = (0,zustand__WEBPACK_IMPORTED_MODULE_5__["default"])((set, get) => {
    ...
    const rootState = {
      ...
      linear: false,
      flat: false,
      scene: prepare(new three__WEBPACK_IMPORTED_MODULE_4__.Scene()),
      controls: null,
...
function createRoot(canvas) {
  ...
  const fiber = prevFiber || reconciler.createContainer(store, react_reconciler_constants__WEBPACK_IMPORTED_MODULE_1__.ConcurrentRoot, null, false, null, '', logRecoverableError, null); // Map it
  ...
  return {
    configure(props = {}) {
      ...
      if ( true) {
        setDeep(three__WEBPACK_IMPORTED_MODULE_4__, legacy, ['ColorManagement', 'legacyMode']);
      }

      const outputEncoding = linear ? three__WEBPACK_IMPORTED_MODULE_4__.LinearEncoding : three__WEBPACK_IMPORTED_MODULE_4__.sRGBEncoding;
      const toneMapping = flat ? three__WEBPACK_IMPORTED_MODULE_4__.NoToneMapping : three__WEBPACK_IMPORTED_MODULE_4__.ACESFilmicToneMapping;
...
function Portal({
  ...
  const inject = react__WEBPACK_IMPORTED_MODULE_0__.useCallback((rootState, injectState) => {
    ...
    if (injectState && size) {
      ...
      viewport = rootState.viewport.getCurrentViewport(camera, new three__WEBPACK_IMPORTED_MODULE_4__.Vector3(), size); // Update the portal camera, if it differs from the previous layer
  ...
  const [usePortalStore] = react__WEBPACK_IMPORTED_MODULE_0__.useState(() => {
    ...
    const store = (0,zustand__WEBPACK_IMPORTED_MODULE_5__["default"])((set, get) => ({ ...previousState,
      scene: container,
      raycaster,
      pointer,
      mouse: pointer,
...
//# sourceMappingURL=js/0bcb7b1723c8bbe89bc6.js.map